...
<body>
    ...
    width: 3em;">
        ...
        <div class="ui simple right dropdown item">
            ...
            <div class="menu">
                ...
                <div class="item active" id="log_out"><i class="sign in alternate icon"></i>Log in</div>
            </div>
        </div>
    </div>
    ...
    <form class="ui form segment" id="form">
        ...
        <div class="two fields">
            <div class="field">
                <a href="#" style="text-decoration:underline; text-align:left; display:block">Forget password</a>
                <br />
                <div class="ui primary submit button" id="button_submit">Submit</div>

            </div>
            <div class="field">
                <a style="cursor:pointer;text-decoration:underline; text-align:right; display:block" id="noakun">I don't have an account</a>
            </div>
        </div>
    </form>
    ...
    <script src="./_js/login2.js"></script>
</body>
