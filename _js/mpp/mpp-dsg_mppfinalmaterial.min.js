...
function ReadAllItem() {
  ...
  if(DUser === GetCookieNego || DUser === GetCookieOpr ){
    ...
    var linkkurs = "";
    var trItemKebutuhan = "";
    var featuresmanagepallet = false;
  }
          ...
          $("#TblSalesContract").append(
            "<tr><td>"+   
              "<table class='ui orange small  very compact table'>"+
                ...
                "<tr class='trHeaderKebutuhan'>"+
                  "<td>KURS 1 USD</td>"+
                  "<td> <a class='ui teal label "+linkkurs+"' kurs='"+response[a]['Kurs']+"' sc='"+response[a]['NoSalesContract']+"' data-tooltip='Edit kurs untuk Sales Contract ini' data-position='right center' data-inverted=''>"+IsNullStrip($.number( response[a]['Kurs'], 0, '.', ',' ))+" IDR</a></td>"+
                "</tr>"+
                "<tr class='trHeaderKebutuhan'>"+
                  "<td>CURRENCY SC</td>"+
              ...
              "<table id='TableList"+a+"' class='ui selectable striped small very compact table tablelist' >"+
                ...
                for (b = 0; b < JmlDataB; b++) {
                  ...
                  $("#TableList"+a).append(
                    ...
                    "<td width='30px' class='center aligned'><span class='BtnUpdateItemPrice' data-tooltip='Tekan Ctrl+Click untuk memperbarui harga material ini' data-inverted='' data-position='left center' scon='"+response[a]['NoSalesContract']+"' matn='"+resp['MaterialNum']+"' desc='"+resp['Description']+"' mtyp='"+resp['MaterialType']+"'><i class='sync circle link  blue icon '></i></span></td>"+
                    "</tr>"
                  );
                }
                if (featuresmanagepallet){
                  $("#TableList"+a).append(
                    "<tr >"+
                      ...
                      "<div class='ui small compact teal labeled icon right aligned button PalletingBtn' nosc='"+response[a]['NoSalesContract']+"' data-tooltip='Pengaturan qty untuk tiap pallet pengiriman' data-position='left center' data-inverted=''><i class='plus icon'></i>Manage Palleting</div>"+
                      "</td>"+
                    "</tr>"
                  );
                }
