                    ...
                    $('.'+section+a).find("tbody").append(
                      "<tr>"+
                        ...
                        "<span class='sub1 BtnAddLv2"+section+"'>"+
                          ...
                          "<div class='ui tealish tiny label SortGroupFieldLv2' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"'><i class='random icon'></i>Lv2</div>"+
                        "</span></td>"+
                        "<div class='ui teal tiny label AddCheckDesigner' sect='"+section+"' lv='L2' idx='"+obj['read_value'][a]['v_id']+"' idbp='"+idbp+ "' nm='"+obj['read_content'][a]['c_name']+ "'><i class='plus circle icon'></i> Add Designer Checker: "+obj['read_content'][a]['c_name']+"</div>"+
...
$("#SaveDisperindag").on("click", function () {
  ...
  var typesupplyreg = $("#typesupplyreg").val().toString();
  var form_data = new FormData();
  ...
  form_data.append("user", Udecrypt);
  form_data.append("typesupplyreg", typesupplyreg);
...
$("#BtnNotAgreePSC").on("click", function () {
  ...
  $('#tabTimeline').on('click', function() {
    let encryption = new Encryption();
    var eidENC = encryption.encrypt(idbp, NonceValue);
    window.location.href = "./?link=bptimeline&i="+eidENC;
  });
