...
function BtnRelease(){
  ...
  $.ajax({
    type: "POST",
    url: `${restlocbp}bp/load-progressbp`,
    headers: {
      user  : vusrnm,
      token : vtoken
    },
    ...
    success: function (response){
      var obj = JSON.parse(response);
      // console.log(obj[0].Progress);
      if(isEmpty(obj)) {
        IsResponseEmptyObj();
      } else {
        if(obj[0].Progress == "WAIT RELEASE"){
...
function LoadDataPICDQA(idc, chk){
  ...
  $.ajax({
    ...
    success: function (response){
      ...
      $("#target_selesaidesg").val(obj['read_checker'][0]['target']);
      // console.log(obj['read_checker'][0]['target']);
      ...
      for (a = 0; a < jmlobj; a++) {
        if(obj['read_checker'][a]['section']==='ELECTRONIC'){
          if(obj['read_checker'][a]['role']==='Designer1'){
            ...
            if(stat === false || obj['read_progress'][0]['final_result'] === 'OK'){
              $(".DesignerChecker1").dropdown("set selected", obj['read_checker'][a]['pic']);
              $(".DesignerChecker1").addClass('disabled');
            }else{
              $(".DesignerChecker1").dropdown("set selected", obj['read_checker'][a]['pic']);
              // $("#Designer1").removeClass('disabled');
            }
            ...
            if(stat === false || obj['read_progress'][0]['final_result'] === 'OK'){
              ...
              $(".DesignerChecker2").addClass('disabled');
            }else{
              $(".DesignerChecker2").dropdown("set selected", obj['read_checker'][a]['pic']);
            }
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
            ...
            if(stat === false || obj['read_progress'][0]['final_result'] === 'OK'){
              ...
              $(".DesignerChecker3").addClass('disabled');
            }else{
              $(".DesignerChecker3").dropdown("set selected", obj['read_checker'][a]['pic']);
            }
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
            ...
            if(stat === false || obj['read_progress'][0]['final_result'] === 'OK'){
              ...
              $(".DesignerChecker4").addClass('disabled');
            }else{
              $(".DesignerChecker4").dropdown("set selected", obj['read_checker'][a]['pic']);
            }
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
            ...
            if(stat === false || obj['read_progress'][0]['final_result'] === 'OK'){
              ...
              $(".DesignerChecker5").addClass('disabled');
            }else{
              $(".DesignerChecker5").dropdown("set selected", obj['read_checker'][a]['pic']);
            }
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
            ...
            if(stat === false || obj['read_progress'][0]['final_result'] === 'OK'){
              ...
              $(".DesignerChecker6").addClass('disabled');
            }else{
              $(".DesignerChecker6").dropdown("set selected", obj['read_checker'][a]['pic']);
            }
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
            ...
            if(stat === false || obj['read_progress'][0]['final_result'] === 'OK'){
              ...
              $(".DesignerChecker7").addClass('disabled');
            }else{
              $(".DesignerChecker7").dropdown("set selected", obj['read_checker'][a]['pic']);
            }
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
  ...
  $.ajax({
    ...
    success: function (response){
      ...
      if (isEmpty(obj)) {
        ...
        jmlProg = obj["read_designerall"].length;
           ...
           )
        {
          ...
          for (a = 0; a < jmlDataa; a++) {
            ...
            //           "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDesigner BtnEditLv1"+section+"' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>Designer Checker 1</span>"+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
            //         "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDQA BtnEditLv1"+section+"' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>DQA Checker</span>"+
            //           "<tbody>"+
            //           "</tbody>"+
            //         "</table>"+
            //       "</div>"
            ...
            // }else{
              ...
              for (a = 0; a < jmlDataa; a++) {
                ...
                for (value_prog = 0; value_prog < jmlProg; value_prog++) {
                  var v_idprog = obj["read_designerall"][value_prog]['id_content'];
                  if(id1 == v_idprog){
                    // var val2   = obj["read_value"][value_a]['v_value'];
                    var strp = obj["read_designerall"][value_prog]['id_content'];
                    break;
                ...
                // console.log(jmlProg);
                if(section === "ELECTRONIC" && id1 === strp){
                  if(id1 === str1 && id1 === str2){
                    $(TC).append(
                      ...
                      "<div>"+
                        "<table class='ui very basic very compact table "+section+a+"'>"+
                          "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDesigner BtnEditLv1"+section+"' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>Designer Checker "+resultfinaldes+"</span>"+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
                        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDQA BtnEditLv1"+section+"' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>DQA Checker "+resultfinalchk+"</span>"+
                          "<tbody>"+
                          "</tbody>"+
                        "</table>"+
                      "</div>"
                    ...
                    $(TC).append(
                      ...
                      "<div>"+
                        "<table class='ui very basic very compact table "+section+a+"'>"+
                          "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDesigner BtnEditLv1"+section+"' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>Designer Checker </span>"+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
                        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDQA BtnEditLv1"+section+"' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>DQA Checker</span>"+
                          "<tbody>"+
                          "</tbody>"+
                        "</table>"+
...
function FungsiTableContent(){
  ...
  $('.AddChildField').click(function(){
    ...
    $('.AddCheckDesigner').click(function(){
      ...
      $("#FieldDesc").val('');
      $("#FieldOption").val('');
      $(".DesignerChecker1").dropdown("clear");
      $(".DesignerChecker1").removeClass('disabled');
      $(".DesignerChecker2").dropdown("clear");
      $(".DesignerChecker2").removeClass('disabled');
      $(".DesignerChecker3").dropdown("clear");
      $(".DesignerChecker3").removeClass('disabled');
      $(".DesignerChecker4").dropdown("clear");
      $(".DesignerChecker4").removeClass('disabled');
      $(".DesignerChecker5").dropdown("clear");
      $(".DesignerChecker5").removeClass('disabled');
      $(".DesignerChecker6").dropdown("clear");
      $(".DesignerChecker6").removeClass('disabled');
      $(".DesignerChecker7").dropdown("clear");
      $(".DesignerChecker7").removeClass('disabled');
      $(".SignDesigner1").text('');
      $(".SignDesigner2").text('');
      $(".SignDesigner3").text('');
      $(".SignDesigner4").text('');
...
$("#UploadFileResult").on("click", function () {
    ...
    $("#SaveRelease").on("click", function () {
      ...
      var hal = $('#BPJumlahHalaman').val();
      var kertas = $('#BPKertas').val();
      var typebp = $('#BPTypeBP').val();
      console.log(sts);
      if (sts ===""){
        Swal.fire({
          title: "<h3>Release Buku Petunjuk ini ?</h3>",
          confirmButtonText: "Ya",
          showCancelButton: true,
        }).then((result) => {
          if (result.value) {
