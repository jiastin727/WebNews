...
var sect = setCookie("section", section, 1);
var jbtn = setCookie("jabatan", jabatan, 1);
...
if(status_bp === 'CANCEL' || status_bp === 'RELEASE'){
  stat = false;
}else{
  stat = true;
}
...
if(progress_bp == "WAIT RELEASE"){
  ...
  $('#headofdqappicrelease').text(pic_he);
...
function LoadDataPICDQA(idc, chk){
  ...
  $.ajax({
    ...
    success: function (response){
      ...
      $("#target_selesai").val(obj['read_checker'][0]['target']);
      console.log(obj['read_setting'][0]['kirim']);
      ...
      for (a = 0; a < jmlobj; a++) {
        if(obj['read_checker'][a]['section']==='ELECTRONIC'){
          if(obj['read_checker'][a]['role']==='Designer1'){
            ...
            $(".DesignerChecker1").text(obj['read_checker'][a]['pic']);
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt && jbt === "HEAD OF"){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                // console.log("SIGN");
                $("#BtnFeedbackResultD1").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
            ...
            $(".DesignerChecker2").text(obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt && jbt === "HEAD OF"){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                // console.log("SIGN");
                $("#BtnFeedbackResultD2").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
            ...
            $(".DesignerChecker3").text(obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt && jbt === "HEAD OF"){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                // console.log("SIGN");
                $("#BtnFeedbackResultD3").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
            ...
            $(".DesignerChecker4").text(obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt && jbt === "HEAD OF"){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                // console.log("SIGN");
                $("#BtnFeedbackResultD4").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
            ...
            $(".DesignerChecker5").text(obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt && jbt === "HEAD OF"){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                // console.log("SIGN");
                $("#BtnFeedbackResultD5").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
            ...
            $(".DesignerChecker6").text(obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt && jbt === "HEAD OF"){
              console.log(obj['read_checker'][a]['result']);
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                // console.log("SIGN");
                $("#BtnFeedbackResultD6").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
            ...
            $(".DesignerChecker7").text(obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt && jbt === "HEAD OF"){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                // console.log("SIGN");
                $("#BtnFeedbackResultD7").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
          ...
          if(obj['read_checker'][a]['role']==='Checker1'){
            // console.log(obj['read_checker'][a]['pic']);
            $("#Checker1").dropdown("set selected", obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            // console.log(obj['read_checker'][a]['rnd_bagian']);
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt || (obj['read_checker'][a]['rnd_bagian'] === sct && jbt === "HEAD OF")){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                // console.log("SIGN");
                $("#BtnFeedbackResultC1").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
                $("#UnsignC1").html("<a class='ui teal tiny label BtnUnsign' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"'>Unsign</a>");
              }else{
                $("#BtnFeedbackResultC1").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
              }
            }else{8
            ...
            $("#Checker2").dropdown("set selected", obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt || (obj['read_checker'][a]['rnd_bagian'] === sct && jbt === "HEAD OF")){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                $("#BtnFeedbackResultC2").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
                $("#UnsignC2").html("<a class='ui teal tiny label BtnUnsign' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"'>Unsign</a>");
              }else{
                $("#BtnFeedbackResultC2").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
              }
            }else{
            ...
            $("#Checker3").dropdown("set selected",obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt || (obj['read_checker'][a]['rnd_bagian'] === sct && jbt === "HEAD OF")){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                $("#BtnFeedbackResultC3").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
                $("#UnsignC3").html("<a class='ui teal tiny label BtnUnsign' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"'>Unsign</a>");
              }else{
                $("#BtnFeedbackResultC3").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
              }
            }else{
            ...
            $("#Checker4").dropdown("set selected",obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt || (obj['read_checker'][a]['rnd_bagian'] === sct && jbt === "HEAD OF")){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                $("#BtnFeedbackResultC4").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
                $("#UnsignC4").html("<a class='ui teal tiny label BtnUnsign' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"'>Unsign</a>");
              }else{
                $("#BtnFeedbackResultC4").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
              }
            }else{
            ...
            $("#Checker5").dropdown("set selected",obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt || (obj['read_checker'][a]['rnd_bagian'] === sct && jbt === "HEAD OF")){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                $("#BtnFeedbackResultC5").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
                $("#UnsignC5").html("<a class='ui teal tiny label BtnUnsign' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"'>Unsign</a>");
              }else{
                $("#BtnFeedbackResultC5").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
              }
            }else{
            ...
            $("#Checker6").dropdown("set selected",obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt || (obj['read_checker'][a]['rnd_bagian'] === sct && jbt === "HEAD OF")){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                $("#BtnFeedbackResultC6").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
                $("#UnsignC6").html("<a class='ui teal tiny label BtnUnsign' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"'>Unsign</a>");
              }else{
                $("#BtnFeedbackResultC6").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
              }
            }else{
            ...
            $("#Checker7").dropdown("set selected",obj['read_checker'][a]['pic']);
            if(obj['read_checker'][a]['status_sign']==='NOT SIGN'){
              var sts_sign = 'Progress';
            } else {
              var sts_sign = 'Signed';
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt || (obj['read_checker'][a]['rnd_bagian'] === sct && jbt === "HEAD OF")){
              if(obj['read_checker'][a]['status_sign']==='SIGN'){
                $("#BtnFeedbackResultC7").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
                $("#UnsignC7").html("<a class='ui teal tiny label BtnUnsign' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"'>Unsign</a>");
              }else{
                $("#BtnFeedbackResultC7").html("<a class='ui teal tiny label BtnSignPIC' idchk='"+obj['read_checker'][a]['id_checker']+"' idvl='"+obj['read_checker'][a]['id_value']+"' role='"+obj['read_checker'][a]['role']+"' pic='"+obj['read_checker'][a]['pic']+"' rd_bag='"+obj['read_checker'][a]['rnd_bagian']+"' sign='"+obj['read_checker'][a]['status_sign']+"'><i class='edit icon'></i></a>&nbsp;&nbsp;");
              }
  ...
  $.ajax({
    ...
    success: function (response){
      ...
      if (isEmpty(obj)) {
        ...
        jmlChecker = obj["read_checker"].length;
        jmlsect = obj["read_sectionprogress"].length;
        jmlmdl = obj["read_modul"].length;
           ...
           )
        {
          ...
          if(status_bp === "RELEASE" || status_bp === "CANCEL"){
            for (a = 0; a < jmlDataa; a++) {
              
              var id1 = obj["read_content"][a]['c_id'];
              for (value_cek = 0; value_cek < jmlChecker; value_cek++) {
                var v_idc = obj["read_checker"][value_cek]['id_value'];
                if(id1 == v_idc){
                  // var val2   = obj["read_value"][value_a]['v_value'];
                  var str = obj["read_checker"][value_cek]['pic'];
                  break;
                } else {
                  var str = "-";
                }  
                ...
                //     "<div>"+
                //       "<table class='ui very basic very compact table "+section+a+"'>"+
                //         "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button green AddCheckDesigner' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"' ><i class='plus small whiteicon icon '></i>Designer Checker</span>"+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
                //       "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button AddCheckDQA'  sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>DQA Checker</span>"+
            ...
            for (a = 0; a < jmlDataa; a++) {
              var id1 = obj["read_content"][a]['c_id'];
              for (value_cek = 0; value_cek < jmlsect; value_cek++) {
                var v_idp = obj["read_sectionprogress"][value_cek]['id_content'];
                if(id1 == v_idp){
                  // var val2   = obj["read_value"][value_a]['v_value'];
                  var str = obj["read_sectionprogress"][value_cek]['id_content'];
                  break;
                } else {
                  var str = "-";
                }  
              }
              for (value_mdl = 0; value_mdl < jmlmdl; value_mdl++) {
                var v_idp = obj["read_modul"][value_mdl]['id_content'];
                var role = obj["read_modul"][value_mdl]['role'];
                // console.log(v_idp);
                if(role == "Designer"){
                  var resultfinaldes = obj["read_modul"][value_mdl]['final_result'];
                  if(id1 === v_idp){
                    // var val2   = obj["read_value"][value_a]['v_value'];
                    var str1 = obj["read_modul"][value_mdl]['id_content'];
                    break;
                ...
                if(role == "Checker"){
                  if(id1 === v_idp){
                    // var val2   = obj["read_value"][value_a]['v_value'];
                    var str2 = obj["read_modul"][value_mdl]['id_content'];
                    var resultfinalchk = obj["read_modul"][value_mdl]['final_result'];
                    // break;
                  // console.log(str2);
              ...
              // console.log(str2);
                ...
                if(id1 === str){
                  ...
                  // console.log(str1);
                  // console.log(str2);
                  if(id1 === str1 && id1 === str2){
                    // console.log(id1);
                    // console.log(str2);
                    // console.log(resultfinalchk);
                    $(TC).append(
                      "<div class='active title'>"+
                        "<i class='dropdown icon'></i>"+obj["read_content"][a]['c_name']+
                      "</div>"+
                      "<div class='active content'>"+
                      "<table class='ui very basic very compact table "+section+a+"'>"+
                        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDesigner' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>Designer Checker "+resultfinaldes+"</span>"+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
                      "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDQA' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>DQA Checker "+resultfinalchk+"</span>"+
                        "<tbody>"+
                        "</tbody>"+
                      "</table>"+
                    "</div>"
                      );
                  }else if(id1 === str1 && id1 !== str2){
                    $(TC).append(
                      "<div class='active title'>"+
                        "<i class='dropdown icon'></i>"+obj["read_content"][a]['c_name']+
                      "</div>"+
                      ...
                      "<table class='ui very basic very compact table "+section+a+"'>"+
                        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDesigner' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>Designer Checker "+resultfinaldes+"</span>"+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
                      "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDQA' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>DQA Checker </span>"+
                        "<tbody>"+
                        "</tbody>"+
                      "</table>"+
                    "</div>"
                    ...
                    if(id1 === str1 && id1 === str2){
                      $(TC).append(
                        ...
                        "<div class='active content'>"+
                        "<table class='ui very basic very compact table "+section+a+"'>"+
                          "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDesigner' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>Designer Checker</span>"+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
                        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDQA' sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>DQA Checker </span>"+
                          "<tbody>"+
                          "</tbody>"+
                        "</table>"+
...
//-------------------------------------------------------
$("#UploadResultChecker").on("click", function () {
  var file_result = $("#fileuploadresult").prop("files")[0];
  var desc_result = $("#NoteResult").val();
  var id_checker = $("#IDChecker").val();
  var result = $("#FieldResult").val();
  var idc = getCookie('IdValueBP');
  var form_data = new FormData();

  form_data.append("file_result", file_result);
  form_data.append("idbp", idbp);
  form_data.append("desc_result", desc_result);
  form_data.append("user", Udecrypt);
  form_data.append("id_checker", id_checker);
  form_data.append("result", result);
  form_data.append("id_l1", idc);
  ...
  $.ajax({
    ...
    contentType: false,
    processData: false,
    url     : `../RND_BackEnd/backend_bp/bp/upload-resultchecker`,
    headers: {
      user: vusrnm,
      token: vtoken,
    },
    ...
    success: function (response) {
      ...
      if (obj.status == false) {
        ...
        $(".xwinuploadcheckerresult").modal("hide");
            //DRAW ARRAY KE DATATABLES
        FungsiSignPIC();
          }
    },
...
$('#BtnEmailRegulasi').click(function(){
  $(".xwinemailregulasi").modal({
    autofocus: false,
  }).modal("show");
  // $("#PSCRejectSection").dropdown("clear");
});
...
$("#BackIHP").on("click", function (e) {
  $(".xwinuploadcheckerresult").modal("hide");
  $(".xwinfeedbackchecker").modal("hide");
});

$('#SaveNewChecker').on('click', function() {
  var idc   = $(this).attr("idc");
        ...
        if(isEmpty(obj)) {
          ...
          for (a = 0; a < jmlData; a++) {
            if(obj[a]["Modul"] === ""){
              ...
              var str = "Download Modul";
            }

            if(obj[a]["NamaFile"] === ""){
              var dl = "";
            }else{
              var dl = "Download File";
            }
            var filelink = "<a target='_blank' href='../RND_Upload/BP/RESULT/"+obj[a]["NamaFile"]+"'>";
            var filemodul = "<a target='_blank' href='../RND_Upload/BP/MODUL/"+obj[a]["Modul"]+"'>";
            $("#TableFeedCheckList").find("tbody").append(
              "<tr>"+ 
                "<td width='10%'>"+obj[a]['result']+"</td>"+
                "<td width='30%'>"+obj[a]['Note']+"</td>"+
                "<td width='10%'>"+obj[a]['Date']+"</td>"+
                "<td width='10%'>"+obj[a]['User']+"</td>"+
                "<td width='15%'>"+filelink+dl+"</td>"+
                "<td width='15%'>"+filemodul+str+"</td>"+
              "</tr><tr></tr>"
            );   
          }
          $("#FootFeedCheckList").empty();
            
          // var PIC = getCookie('pic_checker');
          if(pic === Udecrypt || (rd_bag === sct && jbt === "HEAD OF")){
            // console.log("1");
            if(sign !== "SIGN"){
              if(stat === false){
                $("#ButtonCheckList").empty();
                $("#TableButtonCheckList").find("tbody").append(
                  "<tr>"+
                  "<td colspan='6'>"+
                  "</td>< /tr>"
                );
                ...
                if(jmlData > 0){  
                  ...
                  $("#TableButtonCheckList").find("tbody").append(
                    "<tr>"+
                    "<td><button class='ui mini button green AddResultChecker' pid='"+idcheck+"'>Add"+
                    "<button class='ui mini button teal SignChecker' pid='"+idcheck+"'>Sign"+
                    "</td></tr>"
                  );
                }else{
                  $("#ButtonCheckList").empty();
...
$("#SaveEmailRegulasi").on("click", function () {
  var emailreg = $("#EmailRegulasi").val().toString();
  // console.log(email);

  $.ajax({
    type: "POST",
    url     : `../RND_BackEnd/backend_bp/bp/save-settingemail`,
    headers: {
      user: vusrnm,
      token: vtoken,
    },
...
function FungsiUnsign(){
  ...
  $('#UnsignModule').on('click', function() {
    let encryption = new Encryption();
    var idchk = $("#idchecker").val();
    var reason = $("#UnsignReason").val();
    // var idvl = $(this).attr('idvl');
    // var idc = getCookie('IdValueBP');
    var role = "Checker";
    var dlink = encryption.encrypt(idbp, NonceValue);
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (obj.status == false) {
              ...
              IsResponseTrue(obj.message);
              $(".xwinunsignmodulebp").modal().modal("hide");
              FungsiSignPIC();
              LoadDataPICDQA(idchk,role);
              $(".xwinaddcheckdqa").modal("hide");
            }
          },
          error: function () {
...
function FungsiTableContent(){
  ...
  $('.AddChildField').click(function(){
    ...
    $('.AddCheckDesigner').click(function(){
      ...
      $("#FieldDesc").val('');
      $("#FieldOption").val('');
      $(".DesignerChecker1").text('');
      $(".DesignerChecker2").text('');
      $(".DesignerChecker3").text('');
      $(".DesignerChecker4").text('');
      $(".DesignerChecker5").text('');
      $(".DesignerChecker6").text('');
      $(".DesignerChecker7").text('');
      $(".SignDesigner1").text('');
      $(".SignDesigner2").text('');
      $(".SignDesigner3").text('');
      $(".SignDesigner4").text('');
    ...
    $('.AddCheckDQA').click(function(){
      ...
      $("#FieldDesc").val('');
      $("#FieldOption").val('');
      $("#Checker1").dropdown("clear");
      $("#Checker2").dropdown("clear");
      $("#Checker3").dropdown("clear");
      $("#Checker4").dropdown("clear");
      $("#Checker5").dropdown("clear");
      $("#Checker6").dropdown("clear");
      $("#Checker7").dropdown("clear");
      $(".SignChecker1").text('');
      $(".SignChecker2").text('');
      $(".SignChecker3").text('');
      $(".SignChecker4").text('');
    ...
    $("#TableButtonCheckList").on("click", ".AddResultChecker", function () {
      var pid = $(this).attr('pid');
      $(".xwinuploadcheckerresult").modal("show");
      $("#IDChecker").val(pid);
    });
    

    $("#TableButtonCheckList").on("click", ".SignChecker", function () {
      var pid = $(this).attr('pid');
      var idc = getCookie('IdValueBP');
      Swal.fire({
        title: "<h3>Apakah anda sudah yakin untuk Sign ?</h3>",
        confirmButtonText: "Ya",
        showCancelButton: true,
      }).then((result) => {
        if (result.value) {
...
function FungsiSaveValue(sc){
  ...
  $('.inputubahvalue').on('change', function() {
    ...
    if((SignRoleCookies !== TabCookies) && (SignRoleCookies !== "HEAD OF "+TabCookies)){
      Swal.fire({
        title: "<h3>Section tidak sesuai!</h3>",
        html: "Anda akan merubah value di Secti]on yang tidak sesuai dengan section anda!<br>Lanjutkan ubah value ?",
        icon: "warning",
        confirmButtonText: "Ya",
        showCancelButton: true,
      }).then((result) => {
...
//-------------------------------------------------------
$("#BackIHPS").on("click", function () {
  $(".windowaddtemplate").modal("hide");
