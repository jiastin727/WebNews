...
function TableListFunc() {
  ...
  var JsonFilter = getCookie('FilterBPMasterTypeBP');
  ...
  setCookie("FilterBPMasterTypeBP", JsonFilter, 5);
...
$(document).ready(function () {
  ...
  $('#addnewtypebp').click(function(){
    $(".xwinaddnewtypebp").modal({ autofocus: false }).modal("show");
  });

});

$("#SaveDataTypeBP").on("click", function () {
  var TypeBP = $('#TypeBP').val();
  $.ajax({
    type    : "POST",
