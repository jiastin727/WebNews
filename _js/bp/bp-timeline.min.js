...
function TableListFunc() {
  ...
  var JsonFilter = getCookie('FilterBPTimeline');
  ...
  if (JenisF) {
    $("#fjns_bp").dropdown("set selected", JenisF);
  ...
  setCookie("FilterBPTimeline", JsonFilter, 5);
  ...
  var DTables = $("#TableList").DataTable({
    ...
    ajax : {
      url     : `../RND_BackEnd/backend_bp/timeline/load/`+JenisFStart,
      type    : "POST",
      headers : {
        user  : VUserName,
        token : VToken,
...
$(document).ready(function () {
  ...
  $(".resetfilter").on("click", function () {
    $("#fcari_bp").val("");
    $("#fjns_bp").dropdown("set selected", "bp");
    var FiterArry = ["", "bp"];
    var JsonFilter = JSON.stringify(FiterArry);
    setCookie("FilterBPTimeline", JsonFilter, 5);
    $("#TableList").DataTable().destroy();
