  ...
  var DTables = $("#BPList").DataTable({
    ...
    columns: [
      ...
      { data: 'designer_bp' },
      {
        data: null,
        render: function (data) {
            var new1 = data['pic'].replace(/-,/g, '');
            var new2 = new1.replace(/,/g, '<br>');
            return new2;
        },
      },
      { data: 'status' },
   ...
   createdRow: function (row, data, index) {
    ...
    var str = data["pic"].replace(/-,/g, '');
      ...
      // if ((myarr.indexOf(Udecrypt) > -1) && (data["status_sign"] == "NO") ) {
      //   $(row).find("td").css("color", ColorOwner);
