      ...
      for (a = 0; a < jmlobj; a++) {
        if(obj['read_checker'][a]['section']==='ELECTRONIC'){
          if(obj['read_checker'][a]['role']==='Designer1'){
            ...
            if(obj['read_checker'][a]['result'] !== "-" || obj['read_checker'][a]['pic'] === Udecrypt || (obj['read_checker'][a]['rnd_bagian'] === sct && jbt === "HEAD OF") && (obj['read_checker'][a]['pic'] !== "" || obj['read_checker'][a]['pic']!== "-")){
           ...
           )
        {
          ...
          for (a = 0; a < jmlDataa; a++) {
            ...
            for (value_cek = 0; value_cek < jmlsect; value_cek++) {
              var v_idp = obj["read_modul"][value_cek]['id_content'];
              var role = obj["read_modul"][value_cek]['role'];
              // console.log(v_idp);
              if(role == "Designer"){
                var resultfinaldes = obj["read_modul"][value_cek]['final_result'];
                if(id1 == v_idp){
                  // var val2   = obj["read_value"][value_a]['v_value'];
                  var str1 = obj["read_modul"][value_cek]['id_content'];
                  break;
              ...
              if(role == "Checker"){
                if(id1 == v_idp){
                  // var val2   = obj["read_value"][value_a]['v_value'];
                  var str2 = obj["read_modul"][value_cek]['id_content'];
                  var resultfinalchk = obj["read_modul"][value_cek]['final_result'];
                  // break;
                ...
                if(id1 == str1 && id1 === str2){
                  ...
                  "<div>"+
                    ...
                    "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='ui mini button teal AddCheckDQA'  sect='"+section+"' idx='"+obj['read_content'][a]['c_id']+"' nm='"+obj['read_content'][a]['c_name']+"'><i class='plus small whiteicon icon '></i>DQA Checker "+resultfinalchk+"</span>"+
                      ...
                      "<tbody>"+"<i class='circle icon yellow'></i>"+
                      "</tbody>"+
                    "</table>"+
                  "</div>"
                  );
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (obj.status == false) {
        ...
        FungsiSignAfterResultPIC(id_checker);
      }
    },
    error: function () {
      window.location.href = "./?link=loclogout";
...
function FungsiSignPIC(){
  ...
  $('.BtnSignPIC').on('click', function() {
    ...
    $.ajax({
      type    : "POST",
      url     : `../RND_BackEnd/backend_bp/bp/resultchecker/`+idvl,
      headers : {
        user  : vusrnm,
        token : vtoken
      },
      ...
      success: function (response){
        ...
        if(isEmpty(obj)) {
          ...
          $("#FeedCheckList").empty();
          // console.log(pic);
          jmlData = obj["read_resultchecker"].length;
          console.log(obj["read_checkerdata"][0]["result"]); 
          console.log(obj["read_checkerdata"][0]["status_sign"]);
          // console.log(obj["read_resultchecker"]);
          
          for (a = 0; a < jmlData; a++) {
            if(obj["read_checkerdata"][0]["result"] === "OK" || obj["read_checkerdata"][0]["result"] === "NOT OK"){
              // console.log("THATS IT");
              var filelink = "<a target='_blank' href='../RND_Upload/BP/RESULT/"+obj["read_resultchecker"][a]["NamaFile"]+"'>";
              var filemodul = "<a target='_blank' href='../RND_Upload/BP/MODUL/"+obj["read_resultchecker"][a]["Modul"]+"'>";
              if(obj["read_resultchecker"][a]["Modul"] === ""){
                var str = "";
              }else{
                var str = "Download Modul";
              }

              if(obj["read_resultchecker"][a]["NamaFile"] === ""){
                var dl = "";
              }else{
              ...
              if(a !== jmlData-1){
                $("#TableFeedCheckList").find("tbody").append(
                  "<tr>"+ 
                    "<td width='10%'><font color='#8d8d8d'>"+obj["read_resultchecker"][a]['result']+"</td>"+
                    "<td width='40%'><font color='#8d8d8d'>"+obj["read_resultchecker"][a]['Note']+"</td>"+
                    "<td width='10%'><font color='#8d8d8d'>"+obj["read_resultchecker"][a]['Date']+"</td>"+
                    "<td width='10%'><font color='#8d8d8d'>"+obj["read_resultchecker"][a]['User']+"</td>"+
                    "<td width='15%'><font color='#8d8d8d'>"+filelink+dl+"</td>"+
                    "<td width='15%'><font color='#8d8d8d'>"+filemodul+str+"</td>"+
                  "</tr><tr></tr>"
                );
              }else{
                $("#TableFeedCheckList").find("tbody").append(
                  "<tr>"+ 
                  "<td width='10%'>"+obj["read_resultchecker"][a]['result']+"</td>"+
                  "<td width='40%'>"+obj["read_resultchecker"][a]['Note']+"</td>"+
                  "<td width='10%'>"+obj["read_resultchecker"][a]['Date']+"</td>"+
                  "<td width='10%'>"+obj["read_resultchecker"][a]['User']+"</td>"+
            ...
            if(sign !== "SIGN"){
              if(stat === false){
                ...
                if(jmlData > 0){ 
                  ...
                  if((obj["read_checkerdata"][0]["result"] === "OK" || obj["read_checkerdata"][0]["result"] === "NOT OK") && obj["read_checkerdata"][0]["status_sign"] === "NOT SIGN"){
                    $("#ButtonCheckList").empty();
                    $("#TableButtonCheckList").find("tbody").append(
                      "<tr>"+
...
function FungsiSignAfterResultPIC(idchecker){

  // $('.BtnSignPIC').on('click', function() {
    var idvl = getCookie("IdValueBP");
    var role    = "Checker";
        ...
        if(isEmpty(obj)) {
          ...
          for (a = 0; a < jmlData; a++) {
            ...
            if(a !== jmlData-1){
              $("#TableFeedCheckList").find("tbody").append(
                "<tr>"+ 
                "<td width='10%'><font color='#8d8d8d'>"+obj[a]['result']+"</td>"+
                "<td width='40%'><font color='#8d8d8d'>"+obj[a]['Note']+"</td>"+
                "<td width='10%'><font color='#8d8d8d'>"+obj[a]['Date']+"</td>"+
                "<td width='10%'><font color='#8d8d8d'>"+obj[a]['User']+"</td>"+
                "<td width='15%'><font color='#8d8d8d'>"+filelink+dl+"</td>"+
                "<td width='15%'><font color='#8d8d8d'>"+filemodul+str+"</td>"+
                "</tr><tr></tr>"
              );
            ...
            // if(sign !== "SIGN"){
              if(stat === false){
                ...
                if(jmlData > 0){  
                  ...
                  $("#TableButtonCheckList").find("tbody").append(
                    "<tr>"+
                    "<td><button class='ui mini button green AddResultChecker' pid='"+idchecker+"'>Add"+
                    "<button class='ui mini button teal SignChecker' pid='"+idchecker+"'>Sign"+
                    "</td></tr>"
                  );
                }else{
                  $("#ButtonCheckList").empty();
