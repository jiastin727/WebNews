// backup selector id jadi pakai default javascript, bukan jquery
// menghindari error id yang memiliki .
            ...
            for (var key in json_input_id) {
                ...
                if(key == "wajib"){
                    ...
                    for( let key_id in id_input){
                        ...
                        let id_in = format_id(id_input[key_id]);
                        let id_in = document.getElementById(id_input[key_id]);
            ...
            for (var key in json_input_id_edit) {
                ...
                if(key == "wajib"){
                    ...
                    for( let key_id in id_input){
                        ...
                        let field_value=$("#"+id_in).val();
                        if ($("#tb_form_edit").find("#"+id_in).length > 0) {
                            // cek field input ada atau tidak
                        ...
                        let id_input = json_input_id[key]; // array berisi id input
                            ...
                            for(let key_id in id_input){
                                ...
                                let id_in = id_input[key_id];
                                    ...
                                    var dataid = id_in.replace(/id_/g,'');
                                    $("#"+id_in).val(obj.data[`${dataid}`]);
                                    let datavalue=obj.data[`${dataid}`];
                                    str_info+=`
                                        <tr>
