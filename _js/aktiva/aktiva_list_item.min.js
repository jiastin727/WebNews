...
function TableListFunc(FilterCariItem,FilterPICItem, FilterJenisItem, FilterStatusItem, FilterProgressItem,FilterTahunItem) {
    var DTables = $("#tableListItem").DataTable({
      ...
      columnDefs: [
        ...
        { className: "collapsing", targets: [4,8] },
  ...
  $('#dwnldxls').on('click', function() {
    ...
    var FilterStatusItem = $("#filterStatusItem").val();
    var FilterProgressItem = $("#filterProgressItem").val();
    var FilterTahunItem = $("#fthn_akt").val();
    $.ajax({
      type    : "GET",
  ...
  $(document).ready(function () {
    ...
    $('.CancelData').click(function () {
        ...
        if (stfilter) {
          $("#filterStatusItem").dropdown("set selected", stfilter);
          var stfilterstart = stfilter;
        } else {
            var stfilterstart = "ALL";
        }
        if (pgfilter) {
          $("#filterProgressItem").dropdown("set selected", pgfilter);
          var pgfilterstart = pgfilter;
        } else {
            var pgfilterstart = "ALL";
        }
        if (thfilter) {
          $("#fthn_akt").dropdown("set selected", thfilter);
    ...
    $("#filterPICItem, #filterJenisItem, #filterStatusItem, #filterProgressItem, #fthn_akt").on(
        "change",
        function () {
        var FilterCariItem = $("#fcariitem").val();
        var FilterPICItem = $("#filterPICItem").val();
    ...
    $(".resetfilter").on("click", function () {
        ...
        var yearnow = d.getFullYear();
        $("#fcariitem").val("");
        $("#filterPICItem").dropdown("set selected", Udecrypt);
        $("#filterJenisItem").dropdown("set selected", "ALL");
        $("#filterStatusItem").dropdown("set selected", "ALL");
        $("#filterProgressItem").dropdown("set selected", "ALL");
        $("#fthn_akt").dropdown("set selected", yearnow);
